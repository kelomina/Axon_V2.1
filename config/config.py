...
ENV_SERVICE_FEATURE_PROCESS_WORKERS = 'SCANNER_SERVICE_FEATURE_WORKERS'
ENV_SERVICE_FEATURE_PROCESS_POOL_ENABLED = 'SCANNER_SERVICE_FEATURE_POOL_ENABLED'
SERVICE_FEATURE_PROCESS_POOL_ENABLED = True
SERVICE_FEATURE_PROCESS_WORKERS = max(1, min(os.cpu_count() or 4, 8))
ENV_SERVICE_IO_THREAD_WORKERS = 'SCANNER_SERVICE_IO_THREAD_WORKERS'
SERVICE_IO_THREAD_WORKERS = int(os.getenv(ENV_SERVICE_IO_THREAD_WORKERS) or min(32, (os.cpu_count() or 4) * 4))
...
ENV_LIGHTGBM_PREDICT_NUM_THREADS = 'SCANNER_LIGHTGBM_PREDICT_NUM_THREADS'
LIGHTGBM_PREDICT_NUM_THREADS = int(os.getenv(ENV_LIGHTGBM_PREDICT_NUM_THREADS) or min(os.cpu_count() or 4, LIGHTGBM_NUM_THREADS_MAX))
